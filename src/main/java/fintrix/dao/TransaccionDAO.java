...
public class TransaccionDAO {
    ...
    public List<Transaccion> listarTransacciones() {
        ...
        String sql = "SELECT u.id as UsuarioID, u.nombre as Usuario, cu.nombre_cuenta as Nombre_Cuenta, "
                + "cu.tipo as Tipo, ca.nombre as Categoria, ca.tipo as Tipo_de_Categoria, "
                + "t.fecha as Fecha, t.tipo as Tipo_Transacción, t.descripcion as Descripción, "
                + "t.monto as Monto, t.created_at as Fecha_Creación FROM transacciones t "
                + "JOIN categorias ca ON t.categoria_id = ca.id "
                + "JOIN cuentas cu ON cu.id = t.cuenta_id "
                + "JOIN usuarios u ON u.id = cu.usuario_id "
                + "ORDER BY u.id, ca.id, cu.id";
