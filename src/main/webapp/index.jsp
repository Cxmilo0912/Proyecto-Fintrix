    ...
    <body class="bg-background-light dark:bg-background-dark font-display">
        <div class="relative flex min-h-screen w-full flex-col items-center justify-center p-4">
            ...
            <div class="w-full max-w-sm text-center">
                ...
                <!-- FORMULARIO -->
                <form action="Pcontrol_Finanzas.html" method="get" class="mt-8 space-y-4">
                    ...
                    <button type="submit"
                       ...
                       class="flex h-12 w-full items-center justify-center rounded-lg bg-primary text-white text-base font-semibold leading-normal transition-colors hover:bg-primary/90">
                            Iniciar Sesión
                        </a>
                ...
                <p class="mt-8 text-sm text-slate-600 dark:text-slate-400">
                    ¿No tienes cuenta?
                    <a href="registro_usuario.jsp" class="text-primary font-semibold hover:underline">
                        Regístrate
                    </a>
                </p>
            </div>
