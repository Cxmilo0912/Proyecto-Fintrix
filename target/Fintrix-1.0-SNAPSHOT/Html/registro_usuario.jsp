            ...
            <main class="flex w-full max-w-md flex-col items-center pt-8">
                ...
                <form class="w-full space-y-4">
                    ...
                    <div class="pt-6 pb-4 w-full">
                        <button class="flex w-full items-center justify-center rounded bg-primary h-14 text-white text-base font-bold leading-normal">
                            <a href="inicio_sesion.jsp">Registrarse</a>
                        </button>
                    </div>
                </form>
                <div class="text-center">
                    <p class="text-slate-600 dark:text-slate-400 text-sm">
                        ¿Ya tienes una cuenta? <a class="font-bold text-primary hover:underline" href="inicio_sesion.jsp">Iniciar sesión</a>
                    </p>
                </div>
            </main>
        </div>
